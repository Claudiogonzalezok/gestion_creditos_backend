...
const declaredArray = body("declared")
  .isArray({ min: 1 })
  .withMessage("declared debe ser un array con al menos un método.");
...
const declaredAmountValid = body("declared.*.declared_amount")
  .isFloat({ min: 0 })
  .withMessage("declared_amount debe ser numérico >= 0.");
...
router.post(
  ...
  [
    body("opening_amount")
      .isFloat({ min: 0 })
      .withMessage("opening_amount debe ser numérico >= 0."),
    body("owner_user_id")
      .optional({ nullable: true })
      .isUUID()
      .withMessage("owner_user_id debe ser UUID."),
    body("branch_id")
      .optional({ nullable: true })
      .isUUID()
      .withMessage("branch_id debe ser UUID."),
    body("observations")
      .optional({ nullable: true })
      .isString()
      .isLength({ max: 500 }),
...
router.get(
  ...
  [
    query("status")
      .optional()
      .isIn(["OPEN", "PENDING_RECONCILIATION", "CLOSED"]),
...
router.post(
  ...
  [
    ...
    body("description")
      ...
      .withMessage("description debe tener entre 3 y 255 caracteres."),
    body("receipt_reference")
      .optional({ nullable: true })
      .isString()
      .isLength({ max: 120 }),
