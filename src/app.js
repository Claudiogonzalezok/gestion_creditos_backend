...
app.use('/api/product-brands',    require('./modules/productBrands/productBrands.routes'));
...
app.use('/api/cash-accounts',require('./modules/cashAccounts/cashAccounts.routes'));
