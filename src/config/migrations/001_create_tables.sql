...
CREATE INDEX IF NOT EXISTS idx_customers_collector ON customers(assigned_collector_id);
...
CREATE INDEX IF NOT EXISTS idx_interest_rates_freq   ON interest_rates(payment_frequency);
CREATE INDEX IF NOT EXISTS idx_interest_rates_active ON interest_rates(active);
CREATE INDEX IF NOT EXISTS idx_interest_rates_amount ON interest_rates(min_amount, max_amount);
...
CREATE INDEX IF NOT EXISTS idx_product_rates_active  ON product_rates(active);
...
CREATE INDEX IF NOT EXISTS idx_credits_frequency  ON credits(payment_frequency);
CREATE INDEX IF NOT EXISTS idx_credits_approved   ON credits(approved_at);
...
CREATE INDEX IF NOT EXISTS idx_credit_products_credit ON credit_products(credit_id);
...
CREATE INDEX IF NOT EXISTS idx_credit_down_payments_credit ON credit_down_payments(credit_id);
CREATE INDEX IF NOT EXISTS idx_credit_down_payments_date   ON credit_down_payments(created_at);
...
CREATE INDEX IF NOT EXISTS idx_collection_sheets_date      ON collection_sheets(sheet_date);
CREATE INDEX IF NOT EXISTS idx_collection_sheets_collector ON collection_sheets(collector_id);

-- ── 18. collection_sheet_details ─────────────────────────────
CREATE TABLE IF NOT EXISTS public.collection_sheet_details (
    id             UUID            PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX IF NOT EXISTS idx_csd_sheet       ON collection_sheet_details(sheet_id);
CREATE INDEX IF NOT EXISTS idx_csd_installment ON collection_sheet_details(installment_id);
...
CREATE INDEX IF NOT EXISTS idx_salaries_active ON salaries(active);
...
CREATE INDEX IF NOT EXISTS idx_commissions_credit ON commissions(credit_id);
CREATE INDEX IF NOT EXISTS idx_commissions_status ON commissions(status);
CREATE INDEX IF NOT EXISTS idx_commissions_week   ON commissions(week_start, week_end);

-- ── 22. commission_liquidations ──────────────────────────────
CREATE TABLE IF NOT EXISTS public.commission_liquidations (
    id                 UUID            PRIMARY KEY DEFAULT gen_random_uuid(),
    user_id            UUID            NOT NULL REFERENCES users(id) ON UPDATE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_comm_liq_user ON commission_liquidations(user_id);
CREATE INDEX IF NOT EXISTS idx_comm_liq_week ON commission_liquidations(week_start);
